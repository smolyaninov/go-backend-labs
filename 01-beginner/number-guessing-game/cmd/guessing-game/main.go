...
import (
	...
	"go-backend-labs/01-beginner/number-guessing-game/internal/domain"
	"go-backend-labs/01-beginner/number-guessing-game/internal/game"
	"go-backend-labs/01-beginner/number-guessing-game/internal/input"
	"go-backend-labs/01-beginner/number-guessing-game/internal/repo"
	"go-backend-labs/01-beginner/number-guessing-game/internal/service"
)
